  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-8rem)] gap-12 p-4">
      ...
      <div className="relative flex items-center justify-center">
        ...
        {isListening && (
          <>
            <div className="absolute w-48 h-48 md:w-64 md:h-64 rounded-full bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-orange-500/20 animate-ping" />
            <div className="absolute w-44 h-44 md:w-56 md:h-56 rounded-full bg-gradient-to-r from-purple-500/30 via-pink-500/30 to-orange-500/30 animate-pulse" />
          </>
        )}
        ...
        >
          ...
          <div
            className={cn(
              ...
              isPressed && "bg-gradient-to-br from-purple-900/50 via-pink-900/50 to-orange-900/50"
            )}
          >
            {/* Ondas internas cuando está activo */}
            <div className="relative flex items-center justify-center">
              {isListening && (
                <div className="absolute w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-r from-purple-500/40 via-pink-500/40 to-orange-500/40 animate-pulse" />
              )}
        ...
        <div
          className={cn(
            ...
            "bg-gradient-to-r from-purple-500/0 via-pink-500/20 to-orange-500/0",
